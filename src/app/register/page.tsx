    ...
    <div className="flex flex-col">
      <div className="space-y-6">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full text-white bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-base px-4 py-3 text-center sm:text-sm sm:px-5 sm:py-2.5 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-primary-800"
          >
            Crear una cuenta
          </button>
