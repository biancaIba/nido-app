...
function getEventDescription(event: Event): string {
  switch (event.category) {
    case "Comida": {
      ...
      const mealConfig = EVENTS_CONFIG.Comida.details?.find(
    ...
    case "Sueño":
      ...
      if (event.details.endTime) {
        ...
        return `Durmió de ${startTime} a ${endTime} hs`;
      }
      return `Comenzó a dormir a las ${startTime} hs`;
    case "Baño": {
      // Busca la etiqueta en español desde la configuración
      const diaperConfig = EVENTS_CONFIG.Baño.details?.find(
    ...
    <div className="flex gap-x-4 p-2 items-center">
      ...
      <div className="flex-1">
        ...
        <Card className="px-4 py-2 mt-2 bg-white border-0 shadow-sm mb-3">
          <span className="text-shark-gray-600">
